# Business Model: Manufacture of electric lighting equipment
...
## Classification
- Repository: `cloud-itonami-isic-2740` ([github.com/cloud-itonami/cloud-itonami-isic-2740](https://github.com/cloud-itonami/cloud-itonami-isic-2740))
- ISIC Rev.5: `2740` — Manufacture of electric lighting equipment
- Domain: `:electric-lighting/manufacturing`
- Social impact: :worker-safety :product-safety :consumer-electrical-safety :photobiological-safety
- Actor: `:electric-lighting-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :electric-lighting/manufacturing — who wants
...
One managed tenant (:electric-lighting/manufacturing):
...
- Do not bypass the `:electric-lighting-plant-operations-governor` for production decisions.
