...
- `cloud-itonami-isic-2740`: `kbb -M:test` green (see the
  ...
  tests / 210 assertions, 0 failures, 0 errors), `kbb -M:lint`
  clean, `kbb -M:dev:run` demo narrative exercises proposal
