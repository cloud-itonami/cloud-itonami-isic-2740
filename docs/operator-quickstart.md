# Operator Quickstart — Manufacture of electric lighting equipment

Shortest path from clone to a verified local dry-run for **ISIC 2740** (`cloud-itonami-isic-2740`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2740.git
cd cloud-itonami-isic-2740
```
...
- Blueprint governor key: `electric-lighting-plant-operations-governor`
- Likely source path: `eleclighting.governor.cljc`
