(ns eleclighting.registry-test
  (:require [clojure.test :refer [deftest is]]
            [eleclighting.registry :as r]))
...
(deftest small-shipment-within-quantity-does-not-exceed
  (is (false? (r/shipment-quantity-exceeded?
               {:quantity-units 5000.0 :shipped-units 1000.0} 200.0))))
...
(deftest known-product-types-are-valid
  (doseq [pt [:led-lamp :led-luminaire :led-driver
              :downlight-fixture :street-light-fixture]]
...
(deftest typical-dielectric-test-kv-is-valid
  ...
  (is (r/dielectric-test-kv-valid? 4.0)))
...
(deftest excessive-dielectric-test-kv-is-invalid
  ...
  (is (not (r/dielectric-test-kv-valid? 4.01))))
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "led-assy-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "led-assy-001" 1)
