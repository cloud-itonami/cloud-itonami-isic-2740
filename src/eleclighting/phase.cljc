(ns eleclighting.phase
  "Phase 0->3 staged rollout for the electric-lighting-equipment
  ...
  `eleclighting.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map an Electric Lighting Plant Operations Governor verdict to a
