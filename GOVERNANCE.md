...
`cloud-itonami-isic-2740` is an OSS open-business blueprint for
electric-lighting-equipment plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Electric Lighting Plant Operations Governor remains independent of the advisor.
